...
for (i = 1; i <= 7; i++) {
    document.getElementById(`myImg${i}`).onclick = () => {
        document.getElementById('ourzoom__modal').style.display = "flex";
    }
}

document.getElementById('close__ourzoom__modal').onclick = () => {
    document.getElementById('ourzoom__modal').style.display = "none";
}
// DIALOG SIGN IN
