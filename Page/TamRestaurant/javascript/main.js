...
function vitasNext() {
    ...
    if (document.querySelector('.listVitas__show').style.transform == `translate3d(-${8*404}px, 0px, 0px)`) {
        document.querySelector('.listVitas__show').style.transform = `translate3d(-${9*404}px, 0px, 0px)`
    }
    if (document.querySelector('.listVitas__show').style.transform == `translate3d(-${7*404}px, 0px, 0px)`) {
        document.querySelector('.listVitas__show').style.transform = `translate3d(-${8*404}px, 0px, 0px)`
    }
...
function vitasPrev() {
    ...
    if (document.querySelector('.listVitas__show').style.transform == `translate3d(-${9*404}px, 0px, 0px)`) {
        document.querySelector('.listVitas__show').style.transform = `translate3d(-${8*404}px, 0px, 0px)`
    }
    console.log(x)
}
